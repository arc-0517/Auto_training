...
# Average CV score on the training set was: 0.6071999039212154
exported_pipeline = make_pipeline(
    SelectFwe(score_func=f_classif, alpha=0.04),
    ExtraTreesClassifier(bootstrap=False, criterion="gini", max_features=0.8, min_samples_leaf=16, min_samples_split=5, n_estimators=100)
)
